...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Contact us to find out more about our Email Marketing Specialist Services.">
    <meta name="author" content="Serbona Applications">
    <title>Email Marketing Specialist | Contact</title>
    ...
    <style>
      ...
      <!-- favicon -->
      <link rel="icon" href="envelope-check.svg">
  ...
  <body>
    ...
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between">
          <i class="bi bi-envelope-check d-none d-lg-inline-block" role="img" aria-label="Email Marketing Specialist Logo" style="font-size: 1.7rem; color: #fff;"></i>
          <a class="py-2 d-none d-md-inline-block" href="index.html">Home</a>
          <a class="py-2 d-none d-md-inline-block" href="portfolio.html">Portfolio</a>
      ...
      <div class="container">
        <main>
          ...
          <div class="row g-5 text-white mb-5">
            <div class="d-none d-md-inline-block col-md-5 col-lg-4 order-md-last">
              <h4 class="d-flex justify-content-between align-items-center mb-3">
                <span class="text-white">Your card</span>
              </h4>
              <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-sm">
                  <div>
                    <h6 class="my-0">Full name</h6>
                    <small class="text-muted" id="cardFirstName">...</small>
                    <small class="text-muted" id="cardLastName"></small>
                  </div>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-sm">
                  <div>
                    <h6 class="my-0">Company</h6>
                    <small class="text-muted" id="cardCompany">...</small>
                  </div>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-sm">
                  <div>
                    <h6 class="my-0">Address</h6>
                    <small class="text-muted" id="cardStreet">...</small>
                    <small class="text-muted" id="cardState"></small>
                    <small class="text-muted" id="cardZIP"></small>
                    <small class="text-muted" id="cardCountry"></small>
                  </div>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-sm">
                  <div>
              ...
              <div class="card p-2">
                <div class="input-group">
                  <span class="input-group-text"><i class="bi bi-telephone" role="img" aria-label="Phone number"></i></span>&nbsp;&nbsp;
                  <span class="text-black" id="cardPhone"> ...</span>
                </div>
            </div>
            </div>
            <div class="col-md-7 col-lg-8 mb-5">
              <form method="post" action="" class="needs-validation" novalidate>
                ...
                <button class="w-100 mt-5 btn btn-secondary btn-lg text-white" type="submit">Submit</button>
              </form>
            </div>
          </div>
        </main>
            ...
            <footer class="container py-5 text-white">
              <div class="row">
                <div class="col-12 col-md">
                  ...
                  <i class="bi bi-envelope-check" role="img" aria-label="Email Marketing Specialist Logo" style="font-size: 1.7rem; color: #fff;"></i>
                  <small class="d-block mb-3 text-white">&copy; 2014–2022</small>
                </div>
                <!--
                ...
                <div class="col-6 col-md">
                  <h5>Resources</h5>
                  <ul class="list-unstyled text-small">
                    <li><a class="text-white" href="email-academy.html">Email Academy</a></li>
                    <li><a class="text-white" href="talent-marketplace.html">Talent Market</a></li>
                  </ul>
                </div>
                <!--
                <div class="col-6 col-md">
                ...
                <div class="col-6 col-md">
                  <h5>About</h5>
                  <ul class="list-unstyled text-small">
                    <li><a class="text-white" href="company.html">Company</a></li>
                    <li><a class="text-white" href="#">Locations</a></li>
                  </ul>
                </div>
              </div>
              <!--
              <div class="mt-5 text-white-50 text-center">
                  <p>Design by <a href="#" class="text-white">Serbona Applications</a>.</p>
              </div>
              -->
            </footer>
          </div>
